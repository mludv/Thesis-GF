...
\textbf{{\Huge Unsupervised Contextual Disambiguation for Tree Structures}} 	\\[0.5cm]
{\Large In the Context of Natural Language Abstract Syntax Trees }\\[0.5cm]
Master's Thesis in Engineering Mathematics and Computational Sciences \setlength{\parskip}{1cm}

{\Large OSCAR KALLDAL, MAXIMILIAN LUDVIGSSON}
...
\begin{center}
	...
	\textbf{{\Large Unsupervised Contextual Disambiguation for Tree Structures}} 	\\[0.5cm]
{\large In the Context of Natural Language Abstract Syntax Trees }\\[0.5cm]
