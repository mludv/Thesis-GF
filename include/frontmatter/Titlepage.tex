...
\input{include/frontmatter/Picture}
...
\textbf{{\Huge 	A context sensitive probabilistic model \\[0.2cm] for  natural language abstract syntax trees}} 	\\[0.5cm]
{\Large A Subtitle that can be Very Much Longer if Necessary}\\[0.5cm]
Master's thesis in Engineering Mathematics and Computational Sciences \setlength{\parskip}{1cm}

{\Large OSCAR KALLDAL, MAXIMILIAN LUDVIGSSON} \setlength{\parskip}{2.9cm}
...
\begin{center}
	...
	\textbf{\Large A context sensitive probabilistic model\\ for  natural language abstract syntax trees} \\[1cm]
